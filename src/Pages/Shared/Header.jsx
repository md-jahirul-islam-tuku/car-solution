    ...
    <div className='lg:w-[1024px] xl:w-[1280px] mx-auto'>
      <div className="navbar py-5">
        <div className="navbar-start">
          ...
          <Link to='/' className="flex items-center gap-1 text-3xl font-bold text-gray-600"><img src={logo} alt="" className='h-14' />Car Solution</Link>
        </div>
        ...
        <div className="navbar-end">
          <Link to='/login' className="btn btn-outline btn-primary font-bold text-lg">Appointment</Link>
        </div>
      </div>
    </div>
  );
