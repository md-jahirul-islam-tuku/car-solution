...
const Article2 = () => {
  return (
    <div className='lg:grid grid-cols-3 px-14 gap-10 py-24'>
      <div className='col-span-1 lg:text-right pb-7 font-thin border-b-8 lg:border-b-0 lg:border-r-8 lg:pr-9 border-primary py-3'>
