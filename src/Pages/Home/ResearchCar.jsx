...
const ResearchCar = () => {
  return (
    <div className='mb-32'>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6' data-aos="zoom-in-up" data-aos-duration="2000">
        <div className='hover:scale-110 cursor-pointer duration-300 hover:shadow-lg border border-gray-300 rounded-2xl pt-5 pb-7 pl-3'>
          <img className='h-16' src={car1} alt="" />
          <p className='text-left pl-2 pt-2 text-primary'>Convertibles</p>
        </div>
        <div className='cursor-pointer hover:scale-110 duration-300 hover:shadow-lg border border-gray-300 rounded-2xl pt-5 pb-7 pl-3'>
